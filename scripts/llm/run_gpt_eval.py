...
phase 2 须提供 ``--phase1-jsonl``。默认：``output/test1/gpt_{OPENAI_MODEL}.jsonl``（model 名经 sanitize）
...
def main() -> int:
    ...
    ap = argparse.ArgumentParser(description="Run OpenAI-compatible GPT on Ethi-AmbRoT benchmark compact")
